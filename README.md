...
| **Static analysis**       | Salesforce Code Analyzer (`code-analyzer.yml`) running the existing PMD ruleset (`scripts/pmd/default_apex.xml`), plus a SonarQube config (`sonar-project.properties`)                                                                                                                                                                                      |
